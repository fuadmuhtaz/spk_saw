...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $criteriaC1 = array("options" => array("min_range"=>12, "max_range"=>60));
    $criteriaC2 = array("options" => array("min_range"=>12, "max_range"=>60));
            ...
            if (isset($_SESSION['errNilaiAlternatif']) && $_SESSION['errNilaiAlternatif']) {
                ...
                for($i = 0; $i < count($alternatif); $i++) {
                    if (isset($nilai[$i])) {
                        echo '<tr>
                                <td class="col-md-1">'.($i+1).'</td>
                                <td class="col-md-3">'.$alternatif[$i]['alternatif'].'</td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[0][]" placeholder="12 - 60" value="'.$nilai[$i]['c1'].'"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[1][]" placeholder="12 - 60" value="'.$nilai[$i]['c2'].'"/></td>
                        ...
                        echo '<tr>
                                <td class="col-md-1">'.($i+1).'</td>
                                <td class="col-md-3">'.$alternatif[$i]['alternatif'].'</td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[0][]" placeholder="12 - 60"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[1][]" placeholder="12 - 60"/></td>
                ...
                for($i = 0; $i < count($alternatif); $i++) {
                    echo '<tr>
                            ...
                            <td class="col-md-1"><input class="form-control" type="text" name="c[2][]" placeholder="1 - n"/></td>
                            <td class="col-md-1"><input class="form-control" type="text" name="c[3][]" placeholder="3 - 15"/></td>
                            <td class="col-md-1"><input class="form-control" type="text" name="c[4][]" placeholder="0 - 30"/></td>
                            <td class="col-md-1"><input class="form-control" type="text" name="c[5][]" placeholder="20 - 40"/></td>
                        </tr>';
                }
            }
